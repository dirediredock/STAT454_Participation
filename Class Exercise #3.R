...
commute <- c(my_commute, 20, 90, 76, 97, 45, 62, 10, 34, 56)
commute
...
## 'var(commute)' versus 'variance' yield the same value through different pathways.
...
#### Here the variance is 972.0556, so a variance > 1000 yields "no".
